  ...
  return (
    <section className="bg-hero-glow relative overflow-hidden px-4 pb-24 pt-20 text-center">
      <div className="mx-auto flex max-w-3xl flex-col items-center">
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-char-700 bg-char-900/80 px-4 py-1.5 text-xs font-medium text-slate-700">
          <span className="pulse-dot h-2 w-2 rounded-full bg-green-400" />
          Recipe Generator &middot; Meal Planner &middot; AI Coach
        </div>

        <h1 className="font-display text-4xl font-bold leading-tight text-slate-900 sm:text-5xl md:text-6xl">
          The Future of
          <br />
        ...
        <div className="mt-9 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <a
            href="#tools"
            className="flex items-center gap-2 rounded-full border border-char-700 bg-char-900 px-7 py-3.5 text-base font-semibold text-slate-700 transition hover:border-char-600 hover:text-slate-900"
          >
            ⬚ Explore Tools
          </a>
        </div>

        <a href="#tools" className="mt-14 text-slate-500 transition hover:text-slate-700" aria-label="Scroll down">
